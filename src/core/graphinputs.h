...
namespace evoplex {
    ...
    public:
        ...
        static GraphInputsPtr GraphInputs::parse(const MainApp* mainApp, const QStringList& header, 
    ...
    private:
        ...
        static void checkAttrCommands(GraphInputs* gi, QStringList& failedAttrs);
    };
